 ...
 * Sistsalon - Gerencia Models, Controllers e Views
...

{
	...
	public function __construct () {
		 ...
		 * controlador padrão (controllers/principal-controller.php) e chama o método index().
		...
		if ( ! $this->controlador ) {
			...
			require_once ABSPATH . '/controllers/principal-controller.php';

			
			// Cria o objeto do controlador "principal-controller.php"

			// Este controlador deverá ter uma classe chamada PrincipalController

			$this->controlador = new PrincipalController();
