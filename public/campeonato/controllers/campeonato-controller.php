<?php
/**
 * CampeonatoController - Controller de exemplo
 *
 * @package SistsalonMVC
 * @since 0.1
 */
class CampeonatoController extends MainController
{
    ...
    public function index() {
        ...
        $modelo = $this->load_model('campeonato/campeonato-model');
		...
		// /views/campeonato/index.php
        require ABSPATH . '/views/campeonato/campeonato-view.php';
