...
<head>
    ...
    <meta name="description" content="Philipe Allan Almeida, Desenvolvedor Web">
    <meta name="keywords" content="philipe, allan, almeida, Desenvolvedor Web, html resume, currículo personal portfolio, html portfolio">
    <meta name="author" content="philipealmeida.com.br">

    <title>Philipe Allan Almeida</title>
...
<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
    <div class="intro">
        <div class="intro-sub">Olá, meu nome é Philipe Allan Almeida</div>
        <h2>Desenvolvedor Web</h2>
        <p>Profissional com experiência na área de tecnologia da informação <br>  com ênfase na área de desenvolvimento de sistemas. <br> Apaixonado por tecnologia! </p>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="custom-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#works">Publicações e Projetos</a></li>
                    ...
                    <ul class="timeline">
                            ...
                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        <h3>Especialização em Desenvolvimento de Aplicações Web</h3>
                                        <span>Pontifícia Universidade Católica de Minas Gerais, Belo Horizonte, BR</span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <p>Agregando conhecimento das tecnologias web, em especial aquelas relacionadas ao desenvolvimento de aplicações, bem como para a adoção de melhores práticas em Engenharia de Software para a Web.</p>
                                    </div><!-- /timeline-body -->
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        <h3>Pós em GESTÃO ESTRATÉGICA DA TECNOLOGIA DA INFORMAÇÃO</h3>
                                        <span>Universidade Estácio de Sá - Brasília, BR</span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <p> Agregar conhecimento nunca é demais, quanto mais você aprende, mais você busca.</p>
                                    </div><!-- /timeline-body -->
                                </div> <!-- /timeline-content -->
                            </div> <!-- /timeline-panel -->
                        </li>
                        ...
                        <li>
                            <div class="posted-date">
                                <span class="month">2010-2014</span>
                            </div><!-- /posted-date -->

                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        <h3>Sistemas da Informação - Bacharelado</h3>
                                        <span>Centro Universitário do Distrito Federal - Brasília , BR </span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <p>Instituição por onde me formei e aprendi a dar valor ao conhecimento.</p>
                                    </div><!-- /timeline-body -->
                                </div> <!-- /timeline-content -->
                            </div><!-- /timeline-panel -->
                        </li>
            ...
            <div class="col-md-12">
                ...
                <div class="resume">
                    <ul class="timeline">
                        <li class="timeline-inverted">
                            <div class="posted-date">
                                <span class="month">2013-Atual</span>
                            </div><!-- /posted-date -->
                            ...
                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        ...
                                        <span>MDS - Ministério do Desenvolvimento Social e Combate à Fome</span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <ul class="list-check-exp">
                                            <li>Desenvolvimento de aplizações WEB e Apoio técnico aos gestores.</li>
                                            <li>Participação do levantamento de requisitos do SISC – Sistema de Informação do Serviço de Convivência e Fortalecimento de Vínculos.</li>
                                            <li>Participação nos processos de implantação dos sistemas da Secretaria Nacional de Assistência Social – SNAS</li>
                                            <li>Ferramentas utilizadas: PHP , Jquery, JavaScript, HTML, CSS, Bootstrap e formulários HTML5, DB2, Oracle e PostgreeSQL.</li>
                                        </ul>
                                    </div><!-- /timeline-body -->
                                </div> <!-- /timeline-content -->
                            </div> <!-- /timeline-panel -->
                        ...
                        <li>
                            ...
                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        <h3>Analista de suporte a Sistemas</h3>
                                        <span>Solução Serviços Especializados Ltda.</span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <ul class="list-check-exp">
                                            <li>Tratamento de Incidentes relacionados a software.</li>
                                            <li>Manutenção de software básico.</li>
                                        </ul>
                                    </div><!-- /timeline-body -->
                                </div> <!-- /timeline-content -->
                            </div><!-- /timeline-panel -->
                        ...
                        <li class="timeline-inverted">
                            <div class="posted-date">
                                <span class="month">2009-2010</span>
                            </div><!-- /posted-date -->
                            ...
                            <div class="timeline-panel wow fadeInUp">
                                <div class="timeline-content">
                                    <div class="timeline-heading">
                                        ...
                                        <span>Mundo da Informática Ltda.</span>
                                    </div><!-- /timeline-heading -->

                                    <div class="timeline-body">
                                        <ul class="list-check-exp">
                                            <li>Aplicativos para web design: Corel Draw, Fireworks, Flash, HTML, Dreamweaver, Photoshop.</li>
                                            <li>Pacote Microsoft Office (Básico e Avançado): Word, Excel, Power Point e Access.</li>
                                            <li>Manutenção e configuração de microcomputadores.</li>
                                        </ul>
                                    </div><!-- /timeline-body -->
                                </div> <!-- /timeline-content -->
                            </div> <!-- /timeline-panel -->
...
<section id="works" class="works-section section-padding">
    <div class="container">
        <h2 class="section-title wow fadeInUp">Publicações e Projetos</h2>
        <!--
...
<section id="blog" class="latest-blog-section section-padding">
    <div class="container">
        <h2 class="section-title wow fadeInUp">Últimos posts publicados.</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright text-center">
                    <p>&copy; Philipe Allan Almeida 2019. Todos os direitos reservados..</p>
                </div>
            </div>
        </div>
    </div>
