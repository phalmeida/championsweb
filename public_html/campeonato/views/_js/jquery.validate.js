...
jQuery.validator.addMethod("dateBRnascimento", function (value, element) {
    //contando chars    
    if (value.length != 10) return (this.optional(element) || false);
    // verificando data
    var data = value;
    ...
    if (ano < 1900) return (this.optional(element) || false);
             ...
             var hoje=new Date();
             d1= Date.UTC(data2.getYear(),data2.getMonth(),data2.getDate(),0,0,0);
             d2= Date.UTC(hoje.getYear(),hoje.getMonth(),hoje.getDate(),0,0,0);
	if(data2.getYear() >= hoje.getYear()){
	
		if (d2<d1) return (this.optional(element) || false);		 
