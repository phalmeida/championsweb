(function ($) {
 "use strict";
    ...
    $("#sparkline3").sparkline([1, 1, 2], {
        type: 'pie',
        sliceColors: ['#011627', '#2EC4B6', '#E71D36']});
    ...
    $("#sparkline9").sparkline([34, 43, 43, 35, 44, 32, 15, 22, 46, 33, 86, 54, 73, 53, 12, 53, 23, 65, 23, 63, 53, 42, 34, 56, 76, 15, 54, 23, 44], {
	 ...
	 $('.sparklineedu').sparkline([ [1], [2], [3], [4, 2], [3], [5, 3] ], { type: 'bar', barColor: '#011627',
        negBarColor: '#2EC4B6',});
	...
	var sparklineCharts = function(){
		 ...
		 $("#sparkline51").sparkline([1, 4], {
			 type: 'pie',
			 height: '140',
			 sliceColors: ['#011627', '#ebebeb']
		 });

		 $("#sparkline52").sparkline([5, 3], {
			 type: 'pie',
			 height: '140',
			 sliceColors: ['#2EC4B6', '#ebebeb']
		 });

		 $("#sparkline53").sparkline([2, 2], {
			 type: 'pie',
			 height: '140',
			 sliceColors: ['#FF9F1C', '#ebebeb']
		 });

		 $("#sparkline54").sparkline([2, 3], {
			 type: 'pie',
			 height: '140',
			 sliceColors: ['#E71D36', '#ebebeb']
		 });
	};
